...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildPromoCarousel({
    ...
    final double cardWidth = (screenWidth * 1.8).clamp(300.0, 400.0).toDouble();
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          ...
                                          onPressed: () async {
                                            // Captura o messenger ANTES de awaits
                                            final messenger = ScaffoldMessenger.of(context);
                                            ...
                                            try {
                                              ...
                                              if (response.statusCode == 200) {
                                                setState(() {
                                                  final existingIndex =
                                                      cartItems.indexWhere((e) => e['id'] == produtoId);
                                                  if (existingIndex >= 0) {
        ...
        Row(
          children: [
            IconButton(
              ...
              onPressed: () => _scroll(_categoryController, false, screenWidth),
            ),
            Expanded(
              child: SizedBox(
                height: 50,
            ...
            IconButton(
              ...
              onPressed: () => _scroll(_categoryController, true, screenWidth),
            ),
          ],
        ),
      ],
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Chip(
          ...
          labelStyle:
              TextStyle(color: isSelected ? Colors.white : Colors.black, fontWeight: FontWeight.bold),
        ),
      ),
    );
  }
        ...
        if (items.isEmpty)
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              final double cardWidth = (constraints.maxWidth * 1.8).clamp(300.0, 300.0).toDouble();
              return SizedBox(
                height: 310,
