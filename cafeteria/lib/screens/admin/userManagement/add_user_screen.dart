...
class _AddUserScreenState extends State<AddUserScreen> {
  ...
  // 1- Adicionar usuário no sistema (Falta verificar quando já existe usuário no sistema !!! // 2- Quando adicionar voltar para o menu)
  void _submit() async {
...
// Falta Código para editar usuário
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Adicionar Usuário'), backgroundColor: Colors.brown,),
      body: Center(
